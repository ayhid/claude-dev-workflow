...
| `reorg classify` \| `shortlist` \| `detect` \| `resolve` \| `map` \| `rewrite` | what each document still is, which two overlap, what only a person can settle, and the reorganised draft as a staged tree | git |
