 ...
 * count is what tells the caller how much is still undecided. An unknown id,
...
export function applyTriage(groups, answers = {}) {
  ...
  for (const g of groups) {
    ...
    if (ruleAnswer !== undefined) applied.push({ rule: g.rule, lifecycle: ruleAnswer, count: decided });
