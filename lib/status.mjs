...
/**
 * Is a missing PR a pending step, or not a thing this repo has (#44)?
 *
 * A repo on `delivery.mode: direct` never opens one, so "none yet" would name
 ...
 * lying around.
 *
 * @param {Array<{path: string, branch: string|null, issue: object|null, pr: object|null|'unknown', dirty: number, delivery?: string|null}>} rows
 */
